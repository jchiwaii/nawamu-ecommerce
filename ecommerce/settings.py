...
SPECTACULAR_SETTINGS = {
    "TITLE": "Shoe Store Ecommerce API",
    "DESCRIPTION": "API-first ecommerce backend with M-Pesa payments and admin operations.",
    "VERSION": "1.0.0",
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", "support@example.com")
...
MPESA = {
    ...
    "SIMULATE": env_bool("MPESA_SIMULATE", DEBUG),
}
